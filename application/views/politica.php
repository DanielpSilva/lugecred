<main id="main">
  ...
  <p>A sua privacidade é importante para nós. É política da LugeCred Empréstimos e Serviços respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://lugecred.com.br />LugeCred Empréstimos e Serviços</a>, e outros sites que possuímos e operamos.</p>
  ...
  <h2>Política de Cookies LugeCred Empréstimos e Serviços</h2>
  ...
  <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que a LugeCred Empréstimos e Serviços oferece no site e com caráter enunciativo, mas não limitativo:</p>
  <ul>
    <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou <a href='https://salmao.pt/'>salmao</a>, apostas desportivas (ex.: Bet.pt), jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) da LugeCred Empréstimos e Serviços, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
  </ul>
